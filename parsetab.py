...
_lr_productions = [
  ...
  ('expression -> expression PLUS','expression',2,'p_expression_binop_plus','calcBase.py',119),
  ('expression -> TRUE','expression',1,'p_expressionTrue','calcBase.py',128),
  ('expression -> FALSE','expression',1,'p_expressionFalse','calcBase.py',133),
  ('statement -> NAME EQUAL expression','statement',3,'p_name_assign','calcBase.py',138),
  ('expression -> expression COMPARE expression','expression',3,'p_expression_binop_bool2','calcBase.py',143),
  ...
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop_times','calcBase.py',158),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop_divide_and_minus','calcBase.py',163),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop_divide_and_minus','calcBase.py',164),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','calcBase.py',169),
  ('expression -> IF expression LACCOL bloc RACCOL','expression',5,'p_condition','calcBase.py',174),
  ('expression -> IF expression LACCOL bloc RACCOL ELSE LACCOL bloc RACCOL','expression',9,'p_condition','calcBase.py',175),
  ('statement -> WHILE expression LACCOL bloc RACCOL','statement',5,'p_loop','calcBase.py',183),
  ('statement -> FOR LPAREN statement SEMICOLON expression SEMICOLON statement RPAREN LACCOL bloc RACCOL','statement',11,'p_for','calcBase.py',188),
  ('params -> expression SEPARATOR params','params',3,'p_params','calcBase.py',193),
  ('params -> expression','params',1,'p_params','calcBase.py',194),
  ('statement -> FUNCTION NAME LPAREN RPAREN LACCOL bloc RACCOL','statement',7,'p_function','calcBase.py',203),
  ('statement -> FUNCTION NAME LPAREN params RPAREN LACCOL bloc RACCOL','statement',8,'p_function','calcBase.py',204),
  ('expression -> NUMBER','expression',1,'p_expression_number','calcBase.py',212),
  ('expression -> NAME','expression',1,'p_name','calcBase.py',217),
  ('expression -> QUOTE expression','expression',2,'p_word','calcBase.py',222),
  ('expression -> NAME QUOTE','expression',2,'p_word','calcBase.py',223),
  ('expression -> NAME expression','expression',2,'p_word','calcBase.py',224),
  ('statement -> NAME LPAREN RPAREN','statement',3,'p_function_call','calcBase.py',235),
  ('statement -> NAME LPAREN params RPAREN','statement',4,'p_function_call','calcBase.py',236),
]
